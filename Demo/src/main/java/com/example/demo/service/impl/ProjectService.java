...
public class ProjectService implements IProjectService {
    ...
    @Autowired
    private SupportCachePageUtil<MyProject> supportCachePageUtil;
    ...
    public List<MyProject> queryPage(Long currentPage,Long pageSize){
        List<MyProject> list = supportCachePageUtil.queryPage(SupportCachePageUtil.PROJECT_INFO_BUSINESS_KEY,currentPage,pageSize,new FindAllCallBack<MyProject>(){
            // 当缓存中没有时，才会执行回调函数的调用，去查询数据库
            @Override
